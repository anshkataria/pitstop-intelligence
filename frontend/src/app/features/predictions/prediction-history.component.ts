...
@Component({
  ...
  styles: [`.layout{display:grid;grid-template-columns:.9fr 1.1fr;gap:18px}.layout>article{padding:22px}.runs button{width:100%;display:grid;grid-template-columns:42px 1fr 25px;align-items:center;gap:10px;min-height:62px;padding:8px 10px;border:0;border-bottom:1px solid var(--ps-border);background:var(--ps-surface);text-align:left;cursor:pointer}.runs button.active{background:var(--ps-red-subtle)}.runs button>span,.runs button>b,.meta{font:500 9px var(--ps-font-mono)}.runs p,.result p{margin:0}.runs strong,.runs small,.result strong,.result small{display:block}.runs small,.result small{margin-top:4px;color:var(--ps-text-secondary);font-size:8px}.meta{display:flex;justify-content:space-between;padding:12px 0 15px;color:var(--ps-text-secondary)}.metrics{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid var(--ps-border);border-radius:var(--ps-radius-sm)}.metrics div{padding:13px;border-right:1px solid var(--ps-border)}.metrics div:last-child{border:0}.metrics span,.metrics strong{display:block}.metrics span{color:var(--ps-text-secondary);font:500 7px var(--ps-font-mono)}.metrics strong{margin-top:7px;font:500 18px var(--ps-font-heading)}.coverage{margin:9px 0 20px;color:var(--ps-text-secondary);font:500 8px var(--ps-font-mono)}.pending{padding:20px;margin-bottom:20px;background:var(--ps-bg);border-radius:var(--ps-radius-sm)}.pending strong,.pending span{display:block}.pending strong{font:600 8px var(--ps-font-mono)}.pending span{margin-top:7px;color:var(--ps-text-secondary);font-size:9px}.classification{padding-top:4px}.result{display:grid;grid-template-columns:32px 1fr 42px 45px;align-items:center;gap:10px;min-height:58px;border-bottom:1px solid var(--ps-border)}.result>b{display:grid;place-items:center;width:29px;height:29px;border-radius:50%;background:var(--ps-text);color:#fff;font:500 10px var(--ps-font-mono)}.actual small,.actual b{display:block;text-align:center}.actual small{color:var(--ps-text-muted);font:500 6px var(--ps-font-mono)}.actual b{margin-top:3px;font:600 11px var(--ps-font-mono)}.muted-value{color:var(--ps-text-muted);text-align:center}.result>em{color:var(--ps-red);font:500 9px var(--ps-font-mono);font-style:normal;text-align:right}.result>em.hit{color:var(--ps-green)}.state{display:grid;place-items:center;min-height:240px;color:var(--ps-text-secondary);font-size:10px}@media(max-width:800px){.layout{grid-template-columns:1fr}}@media(max-width:460px){.metrics{grid-template-columns:1fr 1fr}.metrics div:nth-child(2){border-right:0}.metrics div:nth-child(-n+2){border-bottom:1px solid var(--ps-border)}}`],
})
