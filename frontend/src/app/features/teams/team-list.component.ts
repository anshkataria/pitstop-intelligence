...
@Component({
  ...
  styles: [`
    .screen-head select{min-width:150px;height:44px;padding:0 14px;border:1px solid #ddd;border-radius:6px;background:#fff}.standings{display:grid;gap:10px}.team{display:grid;grid-template-columns:48px minmax(210px,1fr) repeat(4,110px);align-items:center;min-height:92px;padding:15px 22px}.position{font:500 22px var(--ps-font-mono);color:#d92332}.identity{border-left:1px solid #e5e5e5;padding-left:20px}.identity small,.identity p,.stat small{color:#777;font:500 8px var(--ps-font-mono);letter-spacing:.06em}.identity h2{margin:5px 0 3px;font-size:17px}.identity p{margin:0}.stat{display:flex;flex-direction:column;gap:5px}.stat strong{font:500 19px var(--ps-font-mono)}.state{padding:60px;text-align:center}@media(max-width:900px){.team{grid-template-columns:40px 1fr repeat(2,80px)}.stat:nth-last-child(-n+2){display:none}}@media(max-width:600px){.team{grid-template-columns:32px 1fr 72px}.stat{display:none}.stat:nth-of-type(3){display:flex}}
  `],
})
